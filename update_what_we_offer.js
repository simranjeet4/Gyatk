...
const cssContent = `/* What We Offer Page Styling matching reference screenshot 100% */
.what-we-offer-root {
  width: 100%;
...
/* Know More Button Styling matching screenshot gradient */
.btn-wrap {
  margin-top: 24px;
}
...
.know-more-btn:hover {
  background: linear-gradient(135deg, #1d4ed8 0%, #c026d3 100%);
  transform: translateY(-2px);
  box-shadow: 0 6px 18px rgba(162, 28, 175, 0.4);
}
...
fs.writeFileSync('client/src/pages/WhatWeOfferPage.jsx', jsxContent);
fs.writeFileSync('client/src/pages/WhatWeOfferPage.css', cssContent);
console.log('Successfully updated WhatWeOfferPage.jsx and WhatWeOfferPage.css!');
