...
const cssContent = `/* Technology Innovation Services Page Styling matching reference screenshot 100% */
.tech-innovation-page-root {
  width: 100%;
...
.tech-innovation-hero-container {
  display: block;
}

.tech-innovation-hero-text {
  max-width: 520px;
}

.tech-innovation-hero-title {
  font-size: 38px;
  font-weight: 800;
  color: #1b355a;
  line-height: 1.25;
...
fs.writeFileSync('client/src/pages/TechInnovationPage.jsx', jsxContent);
fs.writeFileSync('client/src/pages/TechInnovationPage.css', cssContent);
console.log('Successfully updated TechInnovationPage.jsx and TechInnovationPage.css!');
